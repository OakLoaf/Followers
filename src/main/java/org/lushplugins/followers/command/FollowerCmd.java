        ...
        public boolean execute(@NotNull CommandSender sender, org.bukkit.command.@NotNull Command command, @NotNull String label, @NotNull String[] args, @NotNull String[] fullArgs) {
            ...
            if (args.length == 0) {
                ...
                if (follower != null) {
                    ...
                    ChatColorHandler.sendMessage(player, Followers.getInstance().getConfigManager().getLangMessage("follower-name-changed").replace("%nickname%", newName));
                }
            }
    ...
    public static class ToggleCmd extends SubCommand {
        ...
        public boolean execute(@NotNull CommandSender sender, org.bukkit.command.@NotNull Command command, @NotNull String label, @NotNull String[] args, @NotNull String[] fullArgs) {
            ...
            if (follower == null || !follower.isSpawned()) {
                ...
                Followers.getInstance().getDataManager().getFollowerUser(player).setFollowerEnabled(false);
            }
