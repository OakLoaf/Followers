    ...
    public FollowerUser loadFollowerUser(UUID uuid) {
        try (Connection conn = conn(); PreparedStatement stmt = conn.prepareStatement(
            ...
            if (resultSet.next()) {
                ...
                FollowerUser newFollowerUser = new FollowerUser(uuid, Bukkit.getPlayer(uuid).getName(), "none", Followers.getInstance().getConfigManager().getDefaultName(), false, false, false);
